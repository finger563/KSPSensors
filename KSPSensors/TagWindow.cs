...
{
	private KSPSensor attachedModule;
	...
	public void Invoke (KSPSensor module, string oldValue)
	{
	...
	{
		Camera c = HighLogic.LoadedSceneIsEditor ?
			EditorLogic.fetch.editorCamera :
			FlightCamera.fetch.mainCamera;
		return c.WorldToViewportPoint (v);
	}
