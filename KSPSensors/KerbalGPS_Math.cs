...
class GPS_Calculations
{
    ...
    private KSPSensor clsLocalKerbalGPSReference = null;
    ...
    *********************************************************************************************/
    ...
    public void Initialise(KSPSensor clsKerbalGPSReference, string strGNSSacronym, string strSBASacronym)
    {
    ...
    *********************************************************************************************/
    ...
    public bool Calculate_GPS_Position(out Vector3 fPosition, out UInt16 uNumSats, out float fPositionErrorEstimate, out float fFilteredAltitude)
    {
        ...
        if (gyGPSCalculationsInitialised)
        {
            ...
            fPosition = clsLocalKerbalGPSReference.vessel.transform.worldToLocalMatrix * clsLocalKerbalGPSReference.vessel.findWorldCenterOfMass();
            ...
            if (uNumSats >= 4)
            {
                ...
                fPosition += clsLocalKerbalGPSReference.vessel.findWorldCenterOfMass();
    ...
    *********************************************************************************************/
    ...
    private void Find_Distances_to_Satellites(Vessel varVessel, Vector3 fKerbinPos, Vector3 fPosition, float fHorizonAngle, ref ushort uNumSats)
    {
        ...
        Vector3 fGPSSatellitePosition = clsLocalKerbalGPSReference.vessel.transform.worldToLocalMatrix * varVessel.findWorldCenterOfMass();
